...
const zabokbecom = require('../config/zabokbecom');

class Treatment {
    constructor() {
        this.CreateKeyAll= zabokbecom.CreateKeyAll;
        this.IgnoreAnalClosed= zabokbecom.IgnoreAnalClosed;
        this.DossierSelect= zabokbecom.DossierSelect;
        this.AcctingSelect= zabokbecom.AcctingSelect;
    }
