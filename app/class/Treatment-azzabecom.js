...
const azzabecom = require('../config/azzabecom');

class Treatment {
    constructor() {
        this.CreateKeyAll= azzabecom.CreateKeyAll;
        this.IgnoreAnalClosed= azzabecom.IgnoreAnalClosed;
        this.DossierSelect= azzabecom.DossierSelect;
        this.AcctingSelect= azzabecom.AcctingSelect;
    }
